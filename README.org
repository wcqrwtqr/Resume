...
|----------------------+----------------------+----------------------------+---------------------+----------+----------------------|
| National Energy      | Sep 2024 - Feb 2026  | SWT/SLS Operationa Manager | Testing & Slickline | 2 Y      |                      |
| Almurabit            | Oct 2022 - July 2024 | Business Dev Manager       | Down hole           | 2 Y      | [[./images/muco.jpg]]    |
...
** Slickline and Well Testing Opertion manager (Iraq - Basra)
Held the position of the operation manager for Slickline services where I was in charge of 2 0.125" Slickline Units from GOES running in BP Rumaila BECL, and MAN unit was running in RATAWI field under TEEPRH.
Was involved in ISO audit then deployment of the three units in ROO and TEEPRH successfully 
Was the focal point for all the auidts, meetings with my clients:
1. ROO BECL 
2. TEERPH
3. Gazprom
I was the focal point to my client in all investigations, RCA report submission and follow up on the operation needs and requirements
...
I made my own YouTube channel for teaching soft skills one important softwares such as Excel, PowerPoint and how can coding help improve the workflow of an engineer in his work.
